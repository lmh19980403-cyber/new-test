const TEMPLATE_GUIDES = {
  "转化案例复盘": {
    ...
    structure: [
      ...
      "小标题：这项技术本来可能死在论文里。",
      "小标题：种智做了什么。写需求匹配、概念验证、中试熟化、孵化陪跑中的具体动作，不写空泛流程。",
  ...
  "方法论拆解": {
    ...
    structure: [
      ...
      "拆成3-5个维度，每个维度包含定义、自测方法、常见误区、种智一手观察。",
...
function buildPrompt() {
  ...
  return `你是“种智孵化器本部公众号纯文字写作 Skill”，以干了15年公众号内容的老编辑标准写稿。
...
async function generateArticle() {
  ...
  try {
    ...
    articleOutput.value = content.trim();
    setStatus("推文已生成");
  } catch (error) {
...
function loadExample() {
  document.querySelector("#topic").value = "把一场概念验证项目路演活动写成种智本部公众号文章";
  ...
  document.querySelector("#materials").value =
    "活动素材：种智在成都高新区菁蓉汇组织了一场概念验证项目路演，参与方包括高校科研团队、企业技术负责人、投资机构代表。现场重点讨论了AI检测、智能硬件、新材料三个方向的早期项目。多位团队提到共同难点：技术指标在实验室可行，但缺少真实应用场景、验证经费和中试资源。种智技术经理人围绕需求匹配、概念验证方案设计、企业场景对接和后续孵化路径做了点评。活动后已有若干项目进入进一步沟通。";
  document.querySelector("#facts").value =
    "种智可引用资质：国家级众创空间、成都首批概念验证中心、成都首批中试熟化平台单位。与国内外50余所高校院所建立成果转化链接，年辅导科技成果转化项目200余项。";
